...
public class TienThuePhiDichVuKhac extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tien_thue_phi_dich_vu_khac);

        Toolbar toolbar = findViewById(R.id.tool_bar_tien_thue_phi_dich_vu_khac);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_tien_thue_phi_dich_vu_khac);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TienThuePhiDichVuKhac.this, MainActivity.class));
            }
        });
    }
