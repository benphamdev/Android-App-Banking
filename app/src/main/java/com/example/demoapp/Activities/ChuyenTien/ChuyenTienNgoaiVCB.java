...
public class ChuyenTienNgoaiVCB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chuyen_tien_ngoai_vcb);
        Toolbar toolbar = findViewById(R.id.tool_bar_chuyen_tien_ngoai_vcb);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_ngoai_vcb);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChuyenTienNgoaiVCB.this, MainActivity.class));
            }
        });
    }
