...
public class ThayDoiHanMucNgayCuaThe extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thay_doi_han_muc_ngay_cua_the);
        Toolbar toolbar = findViewById(R.id.tool_bar_thay_doi_han_muc_ngay_cua_the);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_thay_doi_han_muc_ngay_cua_the);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ThayDoiHanMucNgayCuaThe.this, MainActivity.class));
            }
        });
    }
