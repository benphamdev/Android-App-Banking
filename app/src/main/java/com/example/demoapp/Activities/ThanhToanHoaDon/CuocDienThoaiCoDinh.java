...
public class CuocDienThoaiCoDinh extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cuoc_dien_thoai_co_dinh);
        Toolbar toolbar = findViewById(R.id.tool_bar_cuoc_dien_thoai_co_dinh);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_cuoc_dien_thoai_co_dinh);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CuocDienThoaiCoDinh.this, MainActivity.class));
            }
        });
    }
}