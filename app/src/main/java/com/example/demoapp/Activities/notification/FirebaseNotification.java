package com.example.demoapp.Activities.notification;
...
public class FirebaseNotification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            for (String key : getIntent().getExtras()
                                         .keySet()) {
                Object value = getIntent().getExtras()
                                          .get(key);
    ...
    public void deviceGroupUpstream() {
        ...
        FirebaseMessaging.getInstance()
                         .send(new RemoteMessage.Builder(to)
        ...
        FirebaseMessaging.getInstance()
                         ...
                         .addOnCompleteListener(new OnCompleteListener<Void>() {
                             ...
                             public void onComplete(
                                 ...
                                 Log.d(TAG, msg);
                                 Toast.makeText(FirebaseNotification.this, msg, Toast.LENGTH_SHORT)
                                      .show();
                             }
                         });
