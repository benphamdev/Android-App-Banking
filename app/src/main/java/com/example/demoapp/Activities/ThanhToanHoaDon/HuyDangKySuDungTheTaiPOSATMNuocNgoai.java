...
public class HuyDangKySuDungTheTaiPOSATMNuocNgoai extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_huy_dang_ky_su_dung_the_tai_posatmnuoc_ngoai);
        Toolbar toolbar = findViewById(R.id.tool_bar_huy_dk_posatm_nuoc_ngoai);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_huy_dk_posatm_nuoc_ngoai);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(
                        HuyDangKySuDungTheTaiPOSATMNuocNgoai.this,
                        MainActivity.class
                ));
            }
        });
