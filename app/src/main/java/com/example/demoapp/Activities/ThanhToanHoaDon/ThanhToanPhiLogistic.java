...
public class ThanhToanPhiLogistic extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thanh_toan_phi_logistic);

        Toolbar toolbar = findViewById(R.id.tool_bar_thanh_toan_phi_logistic);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_thanh_toan_phi_logistic);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ThanhToanPhiLogistic.this, MainActivity.class));
            }
        });
    }
