...
public class MoTietKiem extends AppCompatActivity {
    ...
    private void savingApi() {
        amount = Long.valueOf(edtSoTienGui.getText()
                                          .toString());
        duration = Integer.parseInt(edtThoiGianGui.getText()
                                                  .toString());
        SavingRequest savingRequest = new SavingRequest(userId, amount, duration);
        Log.d("AAAAAA", amount + " " + userId + " " + duration);

        ApiService.apiService.createSavingAccount(savingRequest)
                             .enqueue(new Callback<BaseResponse<Saving>>() {
                                 @Override
                                 public void onResponse(
                                         Call<BaseResponse<Saving>> call,
                                         Response<BaseResponse<Saving>> response
                                 ) {
                                 ...
                                 public void onFailure(
                                         Call<BaseResponse<Saving>> call, Throwable throwable
                                 ) {
