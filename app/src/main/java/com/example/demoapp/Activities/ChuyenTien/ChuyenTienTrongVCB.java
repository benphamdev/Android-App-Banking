...
public class ChuyenTienTrongVCB extends AppCompatActivity {
    ...
    private void transferApi() {
        toAccountNumber = stkNhan.getText()
                                 .toString();
        amount = Long.valueOf(soTienChuyen.getText()
                                          .toString());
        ...
        ApiService.apiService.transfer(request)
    ...
    private void process() {
        ...
        ApiService.apiService.getAccountById(manager.getUserId())
                             .enqueue(new Callback<BaseResponse<AccountInfoResponse>>() {
                                 @Override
                                 public void onResponse(
                                         Call<BaseResponse<AccountInfoResponse>> call,
