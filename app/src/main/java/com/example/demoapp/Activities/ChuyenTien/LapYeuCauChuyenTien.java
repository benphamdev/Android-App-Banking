...
public class LapYeuCauChuyenTien extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lap_yeu_cau_chuyen_tien);
        Toolbar toolbar = findViewById(R.id.tool_bar_chuyen_tien_lap_yeu_cau_chuyen_tien);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_lap_yeu_cau_chuyen_tien);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LapYeuCauChuyenTien.this, MainActivity.class));
            }
        });
    }
}