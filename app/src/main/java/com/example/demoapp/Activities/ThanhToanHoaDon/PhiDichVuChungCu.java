...
public class PhiDichVuChungCu extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_phi_dich_vu_chung_cu);
        Toolbar toolbar = findViewById(R.id.tool_bar_phi_dich_vu_chung_cu);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_phi_dich_vu_chung_cu);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PhiDichVuChungCu.this, MainActivity.class));
            }
        });
    }
