...
public class RutTienTuTietKiem extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rut_tien_tu_tiet_kiem);
        Toolbar toolbar = findViewById(R.id.tool_bar_rut_tien_tu_tiet_kiem);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_rut_tien_tu_tiet_kiem);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RutTienTuTietKiem.this, MainActivity.class));
            }
        });
    }
}