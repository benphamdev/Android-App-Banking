...
public class RutTienMatTaiVNPOST extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rut_tien_mat_tai_vnpost);
        Toolbar toolbar = findViewById(R.id.tool_bar_rut_tien_mat_tai_vnpost);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_rut_tien_mat_vnpost);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RutTienMatTaiVNPOST.this, MainActivity.class));
            }
        });
    }
