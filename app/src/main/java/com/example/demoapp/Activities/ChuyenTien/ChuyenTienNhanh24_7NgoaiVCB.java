...
public class ChuyenTienNhanh24_7NgoaiVCB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chuyen_tien_nhanh247_ngoai_vcb);
        Toolbar toolbar = findViewById(R.id.tool_bar_chuyen_tien_24_7);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChuyenTienNhanh24_7NgoaiVCB.this, MainActivity.class));
            }
        });
    }
