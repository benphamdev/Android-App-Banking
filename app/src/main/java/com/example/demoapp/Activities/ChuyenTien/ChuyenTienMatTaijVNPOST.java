...
public class ChuyenTienMatTaijVNPOST extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chuyen_tien_mat_taij_vnpost);
        Toolbar toolbar = findViewById(R.id.tool_bar_chuyen_tien_vnpost);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_chuyen_tien_vnpost);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChuyenTienMatTaijVNPOST.this, MainActivity.class));
            }
        });
    }
}