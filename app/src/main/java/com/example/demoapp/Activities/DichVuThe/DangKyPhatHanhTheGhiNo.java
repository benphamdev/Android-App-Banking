...
public class DangKyPhatHanhTheGhiNo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dang_ky_phat_hanh_the_ghi_no);
        Toolbar toolbar = findViewById(R.id.tool_bar_dang_ky_phat_hanh_the_ghi_no);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_dang_ky_phat_hanh_the_ghi_no);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DangKyPhatHanhTheGhiNo.this, MainActivity.class));
            }
        });
    }
