...
public class LoanDisbursementAdapter extends RecyclerView.Adapter<LoanDisbursementAdapter.LoanDisbursementViewHolder> {
    ...
    @NonNull
    @Override
    public LoanDisbursementViewHolder onCreateViewHolder(
            @NonNull ViewGroup parent, int viewType
    ) {
        View view = LayoutInflater.from(parent.getContext())
                                  .inflate(R.layout.loan_disbursement, parent, false);
    ...
    public void onBindViewHolder(
            @NonNull LoanDisbursementViewHolder holder, int position
    ) {
    ...
    private void showDeleteConfirmationDialog(int position) {
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(
                        ...
                        (dialog, which) -> deleteLoanBurse(position)
                )
    ...
    public void deleteLoanBurse(int position) {
        int loanId = loanDisbursementList.get(position)
                                         .getLoanDetail()
                                         .getId();
    ...
    public class LoanDisbursementViewHolder extends RecyclerView.ViewHolder {
        ...
        public LoanDisbursementViewHolder(
