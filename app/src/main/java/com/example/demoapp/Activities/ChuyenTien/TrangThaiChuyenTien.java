...
public class TrangThaiChuyenTien extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trang_thai_chuyen_tien);
        Toolbar toolbar = findViewById(R.id.tool_bar_trang_thai_chuyen_tien);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_trang_thai_chuyen_tien);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TrangThaiChuyenTien.this, MainActivity.class));
            }
        });
    }
