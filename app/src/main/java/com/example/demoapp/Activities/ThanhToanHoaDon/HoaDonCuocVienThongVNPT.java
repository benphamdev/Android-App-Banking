...
public class HoaDonCuocVienThongVNPT extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hoa_don_cuoc_vien_thong_vnpt);

        Toolbar toolbar = findViewById(R.id.tool_bar_cuoc_dien_tu_vien_thong_vnpt);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");

        // Lấy hình ảnh icon trở lại từ ImageView
        ImageView backButton = findViewById(R.id.toolbar_back_cuoc_dien_tu_vien_thong_vnpt);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HoaDonCuocVienThongVNPT.this, MainActivity.class));
            }
        });
    }
